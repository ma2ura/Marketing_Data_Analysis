...
試行回数`trial_count`とサイコロを振る回数`sample_sizes`を引数にした関数を作成すると、さらに便利になります。
...
average_life <- 1800
standard_dev <- 180
lifetime_sample <- tibble(lifetime = rnorm(1000, mean = average_life, sd = standard_dev))
lifetime_sample |>
